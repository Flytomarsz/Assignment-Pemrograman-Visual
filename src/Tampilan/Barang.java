...
public class Barang extends javax.swing.JFrame {
    ...
    protected void datatable() {
        Object[] Baris = {"Kode barang", "Nama Barang", "Kategori", "Harga Beli", "Harga Jual" };
        tabmode = new DefaultTableModel(null, Baris);
        String caritterm = txtcari.getText();

        try {
            String sql = "SELECT * FROM barang where kode_brg like '%" + caritterm + "%' or nm_brg like '%" + caritterm + "%' order by kode_brg asc";
    ...
    private void initComponents() {
        ...
        cmbkategori.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-- Pilih --", "Facial Wash", "Toner", "Serum", "Moisturizer", "Sunscreen", "Perfume" }));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtkd, javax.swing.GroupLayout.DEFAULT_SIZE, 226, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtbrg, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txthrgbeli, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel6, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txthrgjual, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(91, 91, 91)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(bsimpan)
                    .addComponent(bubah)
    ...
    private void bsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bsimpanActionPerformed
        ...
        try {
            ...
            stat.setString(3, cmbkategori.getSelectedItem().toString());
    ...
    private void bubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bubahActionPerformed
        try {
            String sql = "update barang set nm_brg=?,kategori=?,hrg_beli=?,hrg_jual=? where kode_brg='" + txtkd.getText() + "'";
            PreparedStatement stat = conn.prepareStatement(sql);
            stat.setString(1, txtbrg.getText());
            stat.setString(2, cmbkategori.getSelectedItem().toString());
    ...
    private void bhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bhapusActionPerformed
        ...
        if (ok == 0) {
            String sql = "delete from barang where kode_brg ='" + txtkd.getText() + "'";
            try {
                PreparedStatement stat = conn.prepareStatement(sql);
                stat.executeUpdate();
                JOptionPane.showMessageDialog(null, "data berhasil dibapus");
                kosong();
                txtkd.requestFocus();
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "data gagal dibapus" + e);
            }
            datatable();
        }
